...
public class ProjectUpdatedConsumer : IConsumer<ProjectUpdated>
{
    ...
    public ProjectUpdatedConsumer(ILogger<ProjectUpdatedConsumer> logger, ICompany company, IMessage message, IUserService user)
    {
        _logger = logger;
        _company = company;
        _message = message;
    ...
    {
        _logger.LogInformation("project update consume");
