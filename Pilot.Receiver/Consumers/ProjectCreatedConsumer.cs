...
public class ProjectCreatedConsumer : IConsumer<ProjectUpdated>
{
    ...
    public ProjectCreatedConsumer(ILogger<ProjectCreatedConsumer> logger, ICompany company, IMessage message, IUserService user)
    {
        _logger = logger;
        _company = company;
        _message = message;
    ...
    {
        _logger.LogInformation("project create consume");
