...
public static class ServiceCollectionExtensions
{
    ...
    {
        AddGetByIdQueryHandlers(services, assembly);
        AddGetValuesQueryHandlers(services, assembly);
    }

    private static void AddGetByIdQueryHandlers(IServiceCollection services, Assembly assembly)
    {
    ...
    private static void AddGetValuesQueryHandlers(IServiceCollection services, Assembly assembly)
    {
        var handlerInterfaceType = typeof(IRequestHandler<,>);
