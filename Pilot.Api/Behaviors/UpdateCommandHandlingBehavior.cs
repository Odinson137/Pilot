...
public class UpdateCommandHandling<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse> where TRequest : IBaseCommand
{
    ...
    public UpdateCommandHandling(ILogger<UpdateCommandHandling<TRequest, TResponse>> logger, IBaseMassTransitService massTransitService)
    {
        _logger = logger;
