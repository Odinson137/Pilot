...
public class JobApplicationTests(
    TestApiFactory apiFactory, // всегда должно быть сверху TODO потом может что-то другое придумать
        ...
        IClassFixture<TestCapabilityFactory>
{
    ...
    public async Task UpdateValue_ReturnOk()
    {
        ...
        var content = await GetContext(ServiceName.CapabilityServer).Set<JobApplication>().FirstOrDefaultAsync(c => c.Id == value.Id);
