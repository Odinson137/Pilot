...
{
    public Task<TOut> SendGetMessage<TOut>(string url, BaseFilter? filter, CancellationToken token);
    
    public Task<TOut?> SendGetOneMessage<TOut>(string url, CancellationToken token);
